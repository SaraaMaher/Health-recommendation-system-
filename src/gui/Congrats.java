 ...
 * @author user
 */
public class Congrats extends javax.swing.JDialog {

    /**
     * Creates new form Congrats
     */
    java.awt.Frame f;
    public Congrats(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.f = parent;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel4.setText("you drank enough water");

        jLabel5.setFont(new java.awt.Font("Candara", 0, 24)); // NOI18N
        jLabel5.setText("Congrats :)");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Congrats dialog = new Congrats(new javax.swing.JFrame(), true);
